...
class ResNet18(PruningModule):
    ...
    def __init__(self, in_channels: int = 1, num_classes: int = 10, init_weights: bool = True, mask: bool = False):
...
# -- The following are from official PyTorch implementation. -- #
...
def _resnet(
    ...
    model = StdResNet18(block, layers, **kwargs)
    return model


def stdresnet18(**kwargs: Any) -> StdResNet18:
    r"""
    ResNet-18 model
    """
