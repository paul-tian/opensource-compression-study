...
def _vgg(cfg: str, batch_norm: bool, **kwargs: Any) -> StdVGG11:
    model = StdVGG11(make_layers(cfgs[cfg], batch_norm=batch_norm, in_channels=kwargs.pop('in_channels', 3)), **kwargs)
    return model


def stdvgg11(**kwargs: Any) -> StdVGG11:
    r"""VGG 11-layer model (configuration "D")
    """
    return _vgg("A", False, **kwargs)


def stdvgg11_bn(**kwargs: Any) -> StdVGG11:
    r"""VGG 11-layer model (configuration "D") with batch normalization
    """
